...
<div id="wrap">
  ...
  <div id="page_secon">
    <div class="title">아우터웨어</div>
    <div class="cate">
      <div class="ca1">
      	<a href="/Cos/cos/women1.jsp?pgender=여&pcategory=아우터웨어">모두보기</a>
      	<a href="/Cos/cos/women1.jsp?pgender=여&pcategory=아우터웨어&psort=재킷">재킷</a>
      	<a href="/Cos/cos/women1.jsp?pgender=여&pcategory=아우터웨어&psort=코트">코트</a>
      </div>
    </div>
  </div>
  <div id="main">
