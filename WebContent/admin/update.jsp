...
<%
  	...
  	try{
  		...
  		Product product = new Product(pid, pname, price, pgender, pcategory, psort, pimage, new java.util.Date());
  ...
  <div id="main">
    <div class="upload">
      <table width="420" height="457" border="0" cellpadding="3" cellspacing="2" id="uploadtable">
        ...
        <tr>
          <td height="90" colspan="4"><a href="/Cos/admin/listProduct.jsp"><img src="/Cos/cos/images/admin/list_btn.jpg" width="305" height="43" /></a></td>
        </tr>
      </table>
    </div>
  </div>
